...
void Enemy::Update()
{
	...
	{
		m_transform->SetPosition({ 0.f, 0.f, 0.f }); // ƒ‚ƒfƒ‹‚ª‚È‚¢ê‡‚Í‰ŠúˆÊ’u‚É–ß‚·
...
{// “G‚Ìƒ‚ƒfƒ‹‚ğ•`‰æ
	...
	{
		DrawSphere3D(m_transform->GetPosition(), 50.0f,7.0f,GetColor(255,0,0), GetColor(255, 0, 0), TRUE); // ƒ‚ƒfƒ‹‚ª‚È‚¢ê‡‚Í‹…‘Ì‚ğ•`‰æ
	}
}
